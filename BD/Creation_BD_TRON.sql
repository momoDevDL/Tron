...
(	
	ID_PARTIE     INT NOT NULL AUTO_INCREMENT,
   	...
   	ID_TOURNOI     VARCHAR(45),
   	ID_MODE     VARCHAR(45) NOT NULL,
...
CONSTRAINT  TOURNOI_FK FOREIGN KEY( ID_TOURNOI ) REFERENCES  TOURNOI  ( ID_TOURNOI ),
CONSTRAINT  MODE_FK FOREIGN KEY( ID_MODE ) REFERENCES  MODE  ( ID_MODE )
);
